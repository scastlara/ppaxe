[![Build Status](https://travis-ci.org/scastlara/ppaxe.svg?branch=master)](https://travis-ci.org/scastlara/ppaxe) [![Coverage Status](https://coveralls.io/repos/github/scastlara/ppaxe/badge.svg?branch=master)](https://coveralls.io/github/scastlara/ppaxe?branch=master) [![PyPI version](https://badge.fury.io/py/ppaxe.svg)](https://badge.fury.io/py/ppaxe)
